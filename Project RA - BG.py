...
imgT = cv2.imread('/Users/macbook/Desktop/a1fdc17f52eb1eb944cf38dec1121fe3.jpeg')
kernel_blur=5
seuil=15
surface=1000
...
while True:
    ...
    for m, n in matches:
        if m.distance < 0.75 * n.distance:
            good.append(m)
    print(len(good))
    imgFeatures = cv2.drawMatches(imgT, Kp1, imgWebcam, Kp2, good, None, flags=2)
...
edictor("shape_predictor_68_face_landmarks.dat")